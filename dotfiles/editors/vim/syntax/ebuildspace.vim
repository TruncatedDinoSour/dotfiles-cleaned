...
syn match  CommonGentooBug contained /\(\([gG]entoo \|[dD]ebian \|[sS]ource[Ff]orge \)\?[Bb]ug \(#\s*\)\?\|#\)\d\{1,\}/
...
hi def link CommonGentooBug                  Underlined

let b:current_syntax = "ebuildspace"
