...
CFLAGS   = -ffast-math -mfancy-math-387 -fno-ident -fmerge-all-constants -fno-unroll-loops -fno-math-errno -std=c99 -pedantic -Wall -Os -ffunction-sections -fdata-sections $(INCS) $(CPPFLAGS)
